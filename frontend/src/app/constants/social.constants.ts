...
export const SOCIAL_ICONS: any = {
    ...
    email: {
      anchor: {
        ariaLabel: {
          en: 'Turkey Airport Transfer Contact via Email', 
          de: 'Türkei Flughafentransfer Kontakt per E-Mail',
          ru: 'Турецкий трансфер из аэропорта свяжитесь по электронной почте',
          tr: 'Türkiye Havaalanı Transferi E-posta ile iletişime geçin',
        },
      }, 
      image: {
        name: {
          en: 'turkey-airport-transfer-email-contact.svg',
          de: 'turkei-flughafentransfer-email-kontakt.svg',
          ru: 'турецкий-трансфер-из-аэропорта-email-контакт.svg',
          tr: 'turkiye-havaalani-transferi-e-posta-ile-iletisim.svg',
        }, 
        alt: {
          en: 'Turkey Airport Transfer Email Contact', 
          de: 'Türkei Flughafentransfer E-Mail Kontakt',
          ru: 'Турецкий трансфер из аэропорта Email контакт',
          tr: 'Türkiye Havaalanı Transferi E-posta İletişim',
        },
      }
    },
    phone: {
      anchor: {
        ariaLabel: {
          en: 'Turkey Airport Transfer Contact via Phone', 
          de: 'Türkei Flughafentransfer Kontakt per Telefon',
          ru: 'Турецкий трансфер из аэропорта свяжитесь по телефону',
          tr: 'Türkiye Havaalanı Transferi Telefon ile iletişime geçin',
        },
      }, 
      image: {
        name: {
          en: 'turkey-airport-transfer-phone-contact.svg',
          de: 'turkei-flughafentransfer-telefon-kontakt.svg',
          ru: 'турецкий-трансфер-из-аэропорта-телефон-контакт.svg',
          tr: 'turkiye-havaalani-transferi-telefon-ile-iletisim.svg',
        }, 
        alt: {
          en: 'Turkey Airport Transfer Phone Contact', 
          de: 'Türkei Flughafentransfer Telefon Kontakt',
          ru: 'Турецкий трансфер из аэропорта Телефон контакт',
