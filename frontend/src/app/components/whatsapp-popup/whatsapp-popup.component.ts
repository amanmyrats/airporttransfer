...
export class WhatsappPopupComponent implements OnInit, OnDestroy {
  ...
  translations: any = {
    ...
    startChatForDiscount: {
      en: 'Start a Whatsapp chat to get discounted price',
      de: 'Starte einen Whatsapp-Chat, um einen Rabattpreis zu erhalten',
      ru: 'Начать чат в Whatsapp, чтобы получить скидку',
      tr: 'İndirimli fiyat için Whatsapp sohbeti başlat',
    },
    needHelp: {
      en: 'Need help? Write for Discount',
      de: 'Brauchen Sie Hilfe? Schreiben Sie für einen Rabatt',
      ru: 'Нужна помощь? Напишите для получения скидки',
      tr: 'Yardım mı lazım? İndirim için yazın',
    },
    chatWithSupport: {
      en: 'Chat with us support team on WhatsApp', 
