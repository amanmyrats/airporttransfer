...
@Component({
  selector: 'app-simple-landing-step-3',
  imports: [
    SuperHeaderComponent, 
    NavbarComponent, 
    FooterComponent, 
  ],
  templateUrl: './simple-landing-step-3.component.html',
  styleUrl: './simple-landing-step-3.component.scss'
})
export class SimpleLandingStep3Component implements OnInit {
